...
if (!admin.apps.length) {
    try {
        ...
        console.log('Firebase initialized successfully in Get Vault');
    } catch (error) {
        console.error("KRITIS: Gagal memuat konfigurasi Firebase di Get Vault.", error);
    }
}
...
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        const doc = await brankasCollection.doc(decodedEmail).get();
